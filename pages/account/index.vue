        ...
        <div class="flex flex-col space-y-6 bg-white shadow p-8 rounded-xl w-full">
            <div class="flex justify-between">
                <div class="flex items-center gap-2">
                    ...
                    <span class="font-bold text-xl">Data Personel</span>    
                </div>
            ...
            <div class="flex border-2 rounded-xl w-full overflow-hidden">
                <table class="border-collapse w-full">
                    <tr class="bg-slate-100 border-b">
                        ...
                        <th class="px-2 py-4 border-r text-slate-800">Telepon</th>
                        <th class="px-2 py-4 border-r text-slate-800">Email</th>
                    ...
                    <tr v-for="(item, index) in dataTable" class="odd:bg-slate-100 even:bg-white border-b">
                        ...
                        <td class="px-2 py-4 border-r font-medium text-slate-800">{{item.telepon}}</td>
                        <td class="px-2 py-4 border-r font-medium text-slate-800">{{item.email}}</td>
                        ...
                        <td class="px-2 font-medium text-center text-slate-800">
                            <div class="flex flex-row gap-2">
                                <NuxtLink :to="`/account/${index + 1}`" class="flex justify-center items-center bg-slate-50 hover:bg-slate-100 m-auto border rounded-full w-10 h-10">
