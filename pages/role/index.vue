<template>
  <div class="flex flex-col space-y-4 px-8 py-4 w-full overflow-y-auto">
    ...
    <div class="p-4 w-full">
        <h1 class="mb-2 font-bold text-3xl">Data Role</h1>
    ...
    <div class="flex flex-col space-y-6 bg-white shadow p-8 rounded-xl w-full">
        <div class="flex justify-between">
            <div class="flex items-center gap-2">
                ...
                <span class="font-bold text-xl">Data Role</span>    
            </div>
            <div class="flex gap-4">
                <ButtonBase label="Tambah Role" icon="i-flowbite-circle-plus-outline" />
            </div>
        </div>
